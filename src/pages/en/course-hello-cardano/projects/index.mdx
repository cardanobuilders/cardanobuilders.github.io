---
title: Projects
description: Complete three projects to demonstrate your Cardano development skills and earn the Hello Cardano course badge.
asIndexPage: true
...
|---|---------|-----------|---------|
| 1 | [Token-Gated Voting](/en/course-hello-cardano/projects/01-token-gated-voting) | Intermediate | 1–6 |
| 2 | [Peer-to-Peer Escrow](/en/course-hello-cardano/projects/02-escrow-marketplace) | Advanced | 1–8 |
| 3 | [Full-Stack Sponsored dApp](/en/course-hello-cardano/projects/03-full-stack-dapp) | Expert | 1–10 |
...
2. **Preprod Transaction Hashes**: For each project, provide at least one preprod transaction hash demonstrating your working implementation. Link to [preprod.cardanoscan.io](https://preprod.cardanoscan.io) so reviewers can verify on-chain.
