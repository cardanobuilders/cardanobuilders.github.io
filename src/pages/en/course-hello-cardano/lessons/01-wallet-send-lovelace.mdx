...
Before we begin, let's prepare our system for development. We will be using Node.js v24+ in this course. We recommend [nvm to manage your node versions](https://github.com/nvm-sh/nvm).
...
In order to create transactions, we need to use APIs to get UTXOs from the network. For this, we will use Blockfrost to get UTXOs and submit transactions. Sign up for a free account and get your API key [here](https://blockfrost.io/).
