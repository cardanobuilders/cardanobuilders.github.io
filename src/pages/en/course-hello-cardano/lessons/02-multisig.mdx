...
To interact with the blockchain, you'll need a wallet extension that supports the CIP30 standard. Choose and download one [here](https://developers.cardano.org/showcase/?tags=wallet).
